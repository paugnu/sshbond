...
actual lifecycle script and bundled xterm FitAddon in a regression test with
controlled DOM dimensions. It checks that zero-size/hidden
...
TypeScript, lint and 165 tests in 15 suites passed. The focused regression
also passes using the real bundled FitAddon. Existing AppLockController
